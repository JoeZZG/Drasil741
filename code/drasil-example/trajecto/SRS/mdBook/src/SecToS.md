...
|\\({R\_{i}}\\)                            |Rectangular field region                    |--                                 |
|\\(s\\)                                   |Dependent variables                         |\\({\text{m}}\\)                   |
|\\({s\_{0}}\\)                            |Initial state vector                        |--                                 |
|\\(t\\)                                   |Time                                        |\\({\text{s}}\\)                   |
|\\({t\_{\text{final}}}\\)                 |Final simulation time                       |\\({\text{s}}\\)                   |
|\\({t\_{\text{hit}}}\\)                   |Time of detector hit                        |\\({\text{s}}\\)                   |
|\\({t\_{\text{max}}}\\)                   |Maximum simulation time                     |\\({\text{s}}\\)                   |
|\\({v\_{\text{max}}}\\)                   |Maximum initial speed                       |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\({v\_{\text{x}}}\\)                     |X-velocity of the particle                  |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\({v\_{\text{x}0}}\\)                    |Initial x-velocity                          |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\({v\_{\text{y}}}\\)                     |Y-velocity of the particle                  |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\({v\_{\text{y}0}}\\)                    |Initial y-velocity                          |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\(\boldsymbol{v}\text{(}t\text{)}\\)     |Velocity                                    |\\(\frac{\text{m}}{\text{s}}\\)    |
|\\(\boldsymbol{v}\text{×}\boldsymbol{B}\\)|Cross product of velocity and magnetic field|--                                 |
